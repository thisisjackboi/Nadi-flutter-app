...
final List<Map<String, dynamic>> MARKETING_UPDATES = [
  {
    'id': 1,
...
final List<Grievance> MOCK_GRIEVANCES = [
  Grievance(
    id: 'GR-2023-8891',
    ...
    isAnonymous: false,
    updates: [
      GrievanceUpdate(date: '2023-10-25', title: 'Grievance Submitted', description: 'Your grievance has been received.', author: 'System'),
      GrievanceUpdate(date: '2023-10-26', title: 'Under Review', description: 'Assigned to Municipal Corp reviewer.', author: 'Admin')
    ]
  ),
  Grievance(
    id: 'GR-2023-8902',
    ...
    isAnonymous: true,
    updates: [
      GrievanceUpdate(date: '2023-10-20', title: 'Submitted', description: 'Received anonymously.', author: 'System'),
      GrievanceUpdate(date: '2023-10-21', title: 'Assigned', description: 'Assigned to Water Works Dept.', author: 'System'),
      GrievanceUpdate(date: '2023-10-22', title: 'Technician Dispatched', description: 'Team is checking the main valve.', author: 'Junior Engineer')
    ]
  ),
  Grievance(
    id: 'GR-2023-7721',
    ...
    isAnonymous: false,
    updates: [
      GrievanceUpdate(date: '2023-09-15', title: 'Submitted', description: 'Reported via Nadi App.', author: 'User'),
      GrievanceUpdate(date: '2023-09-18', title: 'Resolved', description: 'Bulb replaced and wiring fixed.', author: 'Line Man')
    ]
  ),
  Grievance(
    id: 'GR-2023-6612',
    ...
    isAnonymous: true,
    updates: [
      GrievanceUpdate(date: '2023-09-10', title: 'Submitted', description: 'Reported via Nadi App.', author: 'User')
    ]
  )
];

const Map<GrievanceCategory, String> CATEGORY_ICONS = {
